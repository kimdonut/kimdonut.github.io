...
> - 패스권
>   - 인벤토리 100칸
> - 인벤토리 용량을 초과하여 아이템을 보관할 수 없습니다. (쿠폰등록 제외)
...
> | ~~기부의 황제~~ | ~~보유 중인 츠리 코인 전체를 기부한 이용자에게 지급~~ | ~~츠리 코인 480경을 모으고 인증~~ | ~~3,000토큰~~
...
> 
> - 금전애호 도박
>   - `-돈받기` 기본 코인이 1만 2,500원으로 적용되고, 더 많은 재화(명예, 인기도)가 지급됩니다.
> - 확률조작 도박러
...
>
> 계산법: 기본 코인 x (인벤토리 레벨 x (**2 ^ 플레이어 레벨**))
